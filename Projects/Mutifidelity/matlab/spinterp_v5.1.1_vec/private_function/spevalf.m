function [z,x] = spevalf(method,f,levelseq,d,indicesRange, ...
												 ...
												 nresults,functionArgType,outputLength,varargin)
...
% Version: 1.3
% 
% Version 1.3.1     July 23, 2020.   Added patial support for vector output
...
if strcmp(lower(vectorized), 'on')
	...
	z(1:nresults) = {zeros(outputLength,size(v,1))};
	res(1:nresults) = {zeros(outputLength,1)};
	if isempty(varpos)
