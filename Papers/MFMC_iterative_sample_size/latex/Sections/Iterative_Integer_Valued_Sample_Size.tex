...
The idea is to solve a sequence of problems \eqref{eq:Sequential_Optimization} to 
compute integer-valued sample sizes by rounding.
...
By design, the total cost of the integer allocation satisfies
\[
