...
Multifidelity methods do not have a level and their costs shouldn't be estimated using $M_L$.}
...
\MH{Multifidelity methods do not have a level and their costs shouldn't be estimated using $M_L$.}
%
\begin{equation}
