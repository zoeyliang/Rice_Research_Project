function ip = spcmpvalscb(d,outputLength,z,y,newlevelseq,levelseq)
...
%          spcmpvalscc.m
% V1.2   : July 29, 2020
%           Added partial supoport for vector output [Jiaxing Liang/Tonatiuh Sanchez-Vizuet]
  ...
  if npoints > 1
    ...
    x = getchebnodes(nord);
	  ...
	  for nkl = 1:nnewlevels
          ...
          barypdstepcb(vals, outputLength,nord, order, x, y(k+1:kend,:));
		  end
		  k = kend;
	  end
  else
