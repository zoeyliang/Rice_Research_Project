...
\Fn{ $[\mathcal{S}^*,\, \boldsymbol{\rho}^*, \,\boldsymbol{C}^*, \xi_{\text{min}}]$ = \textbf{Backtrack} $\left(\mathcal{S}, \,\boldsymbol{\rho}, \,\boldsymbol{C}, \,k_{\text{last}}\right)$}{
...
$[\mathcal{S}^*,\, \boldsymbol{\rho}^*, \,\boldsymbol{C}^*, \xi_{\text{min}}]=$ \textbf{Backtrack} $(\mathcal{S},\, \boldsymbol{\rho},\, \boldsymbol{C},\, 2)$. 
