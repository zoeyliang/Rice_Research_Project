...
\]
%
\JLcolor{In the later context, Denote $\rho_{k}$ as $\rho_{1,k}$ for short.} Using the variances of $k$-th correction terms and covariances between the first and $k$-th correction terms, the variance of the multi-fidelity Monte Carlo estimator can be expressed as
%
\begin{align}
    \nonumber
