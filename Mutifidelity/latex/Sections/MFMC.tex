...
\caption{Multifidelity Monte Carlo--\JLcolor{slightly different from \cite[Algorithm~2]{PeWiGu:2016}}}
\end{algorithm}
\ULforem
...
Condition (ii) indicates $\beta>\gamma$.
...
\begin{align*}
    ...
    &\sim \epsilon^{-2} \left(M_L^{\frac{\gamma-\beta}{2}}+\sum_{k=2}^{L+1}M_{L-k+1}^\frac{\gamma_1-\beta_1}{2}\right)^2=\epsilon^{-2} \left(M_L^{\frac{\gamma-\beta}{2}}+\sum_{p=0}^{L-1}M_{p}^\frac{\gamma_1-\beta_1}{2}\right)^2\sim \epsilon^{-2}\left(s^{\frac{(\gamma-\beta)}{2}L}+\sum_{p=0}^{L-1}s^{\frac{(\gamma_1-\beta_1)}{2}p}\right),
\end{align*}
%
...
\epsilon^{-2+\frac{\beta-\gamma}{\alpha}}, & \beta_1>\gamma_1\\
