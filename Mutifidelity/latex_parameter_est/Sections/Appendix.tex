...
% Since $f(N)=1/N, f^\prime (N)=-1/N^2, f^{\prime\prime}(N)=2/N^3>0$ for $N>0$. Therefore, optimization problem \eqref{eq:Optimization_pb_sample_size} with variance \eqref{eq:MFMC_var_convex} is a convex optimization problem, and local minimum is the global minimum.
